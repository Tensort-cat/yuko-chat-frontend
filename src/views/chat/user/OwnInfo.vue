    ...
    <div class="chat-window" :style="{
      ...
      <el-container class="chat-window-container">
        ...
        <div class="owner-info-window">
          ...
          <p class="owner-prefix">
            加入yuko chat server的时间：{{ userInfo.created_at }}
          </p>
          <div class="owner-opt">
            ...
            <el-scrollbar max-height="300px" style="
              ...
              <div class="modal-body">
                <el-form ref="formRef" :model="updateInfo" label-width="70px">
                  ...
                  <el-select v-model="updateInfo.gender" placeholder="性别" style="width: 100%; margin-bottom: 20px">
                  ...
                  <el-form-item prop="birthday" label="生日">
                    <el-input v-model="updateInfo.birthday" placeholder="选填，格式为20240618" />
                  </el-form-item>
...
export default {
  ...
  setup() {
    ...
    const closeMyInfoModal = async () => {
      ...
      if (data.updateInfo.gender != "") {
        data.userInfo.gender = data.updateInfo.gender;
      }
